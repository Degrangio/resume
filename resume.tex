...
\centerline{3841 Manayunk Ave \textbullet \hspace{5pt} Philadelphia, PA 19128 \textbullet \hspace{5pt} (732)-598-5774}
...
\newcommand{\ExecutiveSummary}
{
    ...
    \centerline{
    \hfill $\bullet$ Gears \hfill $\bullet$ DDS \hfill $\bullet$ UDP \hfill $\bullet$ Angular2 \hfill $\bullet$ Express \hfill $\bullet$ MySQL \hfill $\bullet$ Node \hfill $\bullet$ HTML5 \hfill $\bullet$ JSON \hfill $\bullet$ LaTeX
    }
    \centerline{
